 ...
 *
 * <p>A {@code ResourceNotifier} can either be passed as a tool method parameter
 * or injected with CDI using {@code @Inject}.</p>
 *
 * <p>Example tool method signature using a method parameter:</p>
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>Example using CDI injection:</p>
 * <pre>{@code
 * @Inject
